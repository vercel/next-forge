...
While next-forge doesn't include BI tooling out of the box, you can easily add business intelligence and analytics to your app with [Metabase](https://www.metabase.com?utm_source=github&utm_medium=repo&utm_campaign=metabase-next-forge).

Try it locally or in the cloud:

[![Self-host Metabase](https://img.shields.io/badge/Self--host-Metabase-blue?logo=metabase)](https://www.metabase.com/start/oss?utm_source=github&utm_medium=repo&utm_campaign=metabase-next-forge)
[![Try Metabase Cloud](https://img.shields.io/badge/Try%20Cloud-Metabase-brightgreen?logo=metabase)](https://metabase.com/start?utm_source=github&utm_medium=repo&utm_campaign=metabase-next-forge)
