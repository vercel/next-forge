...
<Note>
To secure your database tables with Row Level Security (RLS) policies, see the [Supabase database migration guide](/migrations/database/supabase#row-level-security-rls) for detailed setup instructions.
</Note>
